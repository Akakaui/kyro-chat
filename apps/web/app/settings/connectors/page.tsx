    ...
    <div className="space-y-10">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-text-secondary">
          Manage MCP servers and custom API integrations.
        </p>
      </div>
      ...
      <section>
        ...
        {mcpServers.length === 0 ? (
          <EmptyState
            ...
            description="Add an MCP server to extend your agent with new tools."
          />
        ) : (
      ...
      <section>
        <div className="mb-4 flex items-center justify-between">
          <div>
            <h2 className="text-sm font-semibold text-text-primary">Custom APIs</h2>
            <p className="mt-0.5 text-xs text-text-muted">
              Connect REST APIs — endpoints are discovered automatically.
            </p>
          </div>
          <Button
            size="sm"
        ...
        {loadingApis ? (
          ...
          <EmptyState
            icon={Key}
            title="No custom APIs added"
            description="Add an API — the agent will discover endpoints for you."
          />
        ) : (
          <div className="space-y-2">
            {customApis.map((api) => (
      ...
      >
        <DialogContent className="max-w-sm bg-bg-secondary">
          <DialogHeader>
            <DialogTitle>
              Delete {deleteTarget?.type === "mcp" ? "Server" : "API"}
            </DialogTitle>
            <DialogDescription>
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-md bg-bg-secondary">
        <DialogHeader>
          ...
          <DialogDescription>
            Enter a name and optional API key. The agent will discover endpoints
            automatically.
          </DialogDescription>
        </DialogHeader>
